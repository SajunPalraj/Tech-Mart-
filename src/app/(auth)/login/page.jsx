...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      showAlert(err?.longMessage || "Failed to initialize Google login.", "error");
    }
  };
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      showAlert(err.errors?.[0]?.longMessage || err?.longMessage || err.message || "Invalid email or password.", "error");
    } finally {
      setLoading(false);
    }
  };
